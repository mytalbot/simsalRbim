...
# Warnings anpassen für item was gewarnt wird! Zicke!
...
cutoff     <- bimUninformed(ydata=predat, GT=GT, simOpt=simOpt, limitToRun=50,  ylim=c(-0.6,1.1)) #
cutoff$cutoff
...
# Filtern nach Transitivitäten und DABEI den CE voll anzugeben!
frqnc      <- bimsim(rawdat=dat, GT=GT, simOpt=simOpt, limitToRun=50, tcut=0.9,
                     filter.crit="Iratio", deviation=0, minQuantity=0, seed=TRUE,
