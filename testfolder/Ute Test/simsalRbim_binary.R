...
###################################################data preparation mit binaren ergebnis 0/1 uns Auswertung simsalRbim######################################
...
data = read.delim("C:/Users/Ute/Backup D Daten/MoPSS Daten und Fotos/#MoPPs script etc/preference ranking/R Ranking Lars/MoPPS Versuch/place_preference_30daysL_inactive time.txt", header= T, sep = "\t", dec= ".")
