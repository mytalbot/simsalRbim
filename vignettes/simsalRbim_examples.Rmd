...
## Preference Tests
For the purpose of this Vignette, we will use the internal ZickeZacke data. This
is a 'perfect' set of preference tests, in which every subject was tested with
every provided item. However, the data contain one item that was not tested with
all subjects and also contains two ties. Let's see if we can evaluate the tests 
and find the item.
