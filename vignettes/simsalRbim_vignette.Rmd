...
results in the plot **OR** the intransitivity ratio (Iratio). The selection
depends on the `filter.crit` paramter ("CE" or "Iratio"). In both cases tcut=0.9
means that 90% values above 90% are not shown. The more
stringent (= lower tcut) the criterion, the more informed the simulation
