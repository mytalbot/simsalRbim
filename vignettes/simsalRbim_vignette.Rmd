...
results in the plot **OR** the transitivity ratio (1-Iratio). The selection
depends on the `filter.crit` parameter ("CE" or "Iratio"), where tcut=0.95 
results in a 95% cutoff. The more stringent (= higher tcut in case of 
transitivity ratios) the criterion, the more informed the simulation
